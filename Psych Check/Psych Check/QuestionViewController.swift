...
public class QuestionViewController: UIViewController {
	...
	public func testFinished() {
		...
		self.dismissVC(completion: {
			...
			print("Total Score: \(scale.totalScore)/\(scale.questions.count)")
		})
		questionNumber = 0
	}
	...
	public func updateQuestion() {
		...
		testProgress.setProgress(Float(questionNumber)/Float(scale.questions.endIndex-1), animated: true)
	}
